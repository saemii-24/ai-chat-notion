    ...
    <div className="p-4 border-t border-slate-900">
      ...
      {isOpen && (
        <div className="mt-4 space-y-4 animate-in fade-in slide-in-from-top-2 duration-200">
          <div>
            <label className="text-[10px] text-slate-500 uppercase font-bold mb-1.5 flex items-center gap-1">
            ...
            <p className="text-[9px] text-slate-600 mt-1">
              developers.notion.com에서 발급받으세요.
            </p>
          </div>

          <div className="grid grid-cols-1 gap-3">
            <div>
              <label className="text-[10px] text-indigo-400 uppercase font-bold mb-1.5 flex items-center gap-1">
              ...
              <input
                ...
                onChange={(e) =>
                  setLocalConfig({ ...localConfig, wordDbId: e.target.value })
                }
            ...
            <div>
              <label className="text-[10px] text-emerald-400 uppercase font-bold mb-1.5 flex items-center gap-1">
          ...
          <div className="p-3 bg-slate-900/50 rounded-lg border border-slate-800">
            <p className="text-[9px] text-slate-500 leading-relaxed">
              <strong>필수 속성 구성:</strong>
              <br />- <strong>단어 DB:</strong> Word(제목), Meaning(텍스트),
              Example(텍스트)
              <br />- <strong>문장 DB:</strong> Sentence(제목), Meaning(텍스트),
              Key Phrases(텍스트)
            </p>
          </div>
        </div>
